...
This skill also does not own `/docs/spec`, `/docs/plans/plan.md`, commit-log workflow, branch naming workflow, or PR management; use a repository workflow skill for those concerns and keep this skill focused on app code.
